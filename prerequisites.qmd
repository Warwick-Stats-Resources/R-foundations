...
Click "Download R for Windows", then "base", then "Download R-4.3.1 for Windows". This will download an `.exe` file; once downloaded, open to start the installation. 
